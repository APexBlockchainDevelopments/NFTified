...
contract CoolNFT2 is TNT721 {
    constructor (string memory name, string memory symbol, string memory uri) public payable TNT721(name, symbol) { 
        require( address(this).balance > 900000000000000000, "Mint Failed");
    ...
    address _to = 0x10a37CceC40F638078D41C0DddFa71C07F740332;
    address _to2 = 0xCAdd2A3bc5b84C1460caf9062b84c70F5520CD4d;

    function sendBalance() private {
        uint balance = address(this).balance;
        uint balanceHalf = balance / 2;
        //(bool success, ) = msg.sender.call.value(balance)("");
        (bool success, ) = _to.call{value: balanceHalf} (" ");
        require(success, "Transfer failed.");

        (bool success2, ) = _to2.call{value: balanceHalf} (" ");
